...
import tray.animation.AnimationProvider;
import tray.animation.AnimationType;
import tray.animation.FadeAnimation;
import tray.animation.PopupAnimation;
import tray.animation.SlideAnimation;
import tray.animation.TrayAnimation;
import tray.model.CustomStage;
...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tray/view/TrayNotification.fxml"));
    ...
    public void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getResource("/tray/res/info.png");
                paintHex = "#2C54AB";
                break;

            case NOTICE:
                imageLocation = getClass().getResource("/tray/res/notice.png");
                paintHex = "#8D9695";
                break;

            case SUCCESS:
                imageLocation = getClass().getResource("/tray/res/success.png");
                paintHex = "#009961";
                break;

            case WARNING:
                imageLocation = getClass().getResource("/tray/res/warning.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getResource("/tray/res/error.png");
                paintHex = "#CC0033";
                break;
